...
import pandas as pd
import numpy as np
# os.chdir('C:\\Users\\Dikshit\\Documents\\Complete DataScience\\YouTube Dataset')
...
def convert_to_videotime():
    #dataframe1=pd.read_csv(dataframe)
    #testdur=dataframe.copy()
    d1=Data['Duration'].str.replace('PT','')
    data1=[]
    for i in d1:
